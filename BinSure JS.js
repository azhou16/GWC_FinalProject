...
var plastic=["water bottles","plastic","plastic forks", "plastic bags", "plastic straws","plastic knives","plastic spoons", "plastic wrap","Gatorade bottles","plastic coat hangers"]
 ...
 if (good_tip!=-1)
	...
	{ var food_soiled=["Chinese food containers", "pizza boxes", "milk cartons"]
	  ...
	  if (good_tip2!=-1)
	  {
		  document.getElementById("tip").innerHTML = '<div id="bulb" style= "margin-bottom: -75px; margin-left: -70px"><img src="Tip Icon.png" height=100px></div><h3>Tip:</h3> <p> All paper products that have been food-soiled should be put in the compost.</p> <br> <a href="#pagetwo" class="ui-btn"style="height: 35px; width: 100px; margin-left: 850px"> See All Tips </a>'
	       
	  }
	  else 
		  
		{ if (search=="styrofoam")
			{ document.getElementById("tip").innerHTML = '<div id="bulb" style= "margin-bottom: -75px; margin-left: -70px; margin-top: -200px"><img src="Tip Icon.png" height=100px></div><h3 style="margin-top: -65px">Tip:</h3> <p> Styrofoam peanuts can be dropped off at many mail houses for reuse.</p> <br> <a href="#pagetwo" class="ui-btn"style="height: 35px; width: 100px; margin-left: 850px"> See All Tips </a>'
				
			}
		else {
				document.getElementById("tip").innerHTML = ' <a href="#pagetwo" class="ui-btn"style="height: 35px; width: 100px; margin-left: 850px"> <p> Tips </p><img src="Tip Icon.png" style= "margin-left: -70px; height: 100px; margin-top: -100px"></a>'
				//get spacing right 
			}   
		}
	}
...
document.getElementById("ans").innerHTML =
		...
		"<br><p>You need to put " + search + " in the recycling. </p> ";
...
{document.getElementById("ans").innerHTML = '<h1>Compost</h1><div id="bin"> <img src="Compost Bin.png" height=500px> </div>';
	document.getElementById("message").innerHTML =
		"<br><p>You need to put " + search + " in the compost. </p> ";
}
function trash_function()
{
	...
	document.getElementById("message").innerHTML =
		"<br><p>You need to put " + search + " in the trash. </p> ";
 ...
 document.getElementById("ans").innerHTML = '<h1>Special</h1> <br> <div id="bin"> <img src="Special Bin.png" height=500px> </div>';
  ...
  if (search=="medicine")
			{
			document.getElementById("message").innerHTML ="<br><p> You need to drop medicine off at a police station or at certain pharmacies. </p>  <em> Medicine flushed down the drain or disposed in the garbage can find its way into the water supply!</em>";
			}
  else  if  (search=="clothes")
			 
			 {
				 document.getElementById("message").innerHTML ='<br><p> You need to fold up clothes in a cardboard box and set up a special pick up with the </p>  <a href="http://www.recyclemyjunk.com/" target="_blank"> RecycleMyJunk Program </a> ';
			 }
				 		 
			 else
			 {
				document.getElementById("message").innerHTML = ' <div><br><p> You need to take ' + search +  ' directly to the  <a href="http://www.recologysf.com/index.php/for-homes/transfer-station-residential" target="_blank"> dump </a> or schedule a pick up with the  <a href="http://www.recyclemyjunk.com/" target="_blank"> RecycleMyJunk Program</a>. </p> </div> ';
			 }
...
function notFound() {
	...
	document.getElementById("message").innerHTML =
		'<b>Tip:</b><em> Is your spelling correct?</em> <br> <em> If so try searching for similar items or choosing similar items from the suggestion bar. </em><br>'; //create quick tips here for plastic and food items and common materials
